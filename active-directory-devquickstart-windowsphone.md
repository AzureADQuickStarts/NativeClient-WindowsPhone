...
-	Gets access tokens for calling the Azure AD Graph API using the [OAuth 2.0 authentication protocol](https://msdn.microsoft.com/en-us/library/azure/dn645545.aspx).
...
- Also in **Configure** tab, locate the "Permissions to Other Applications" section.  For the "Windows Azure Active Directory" application, add the **Access Your Organization's Directory** permission under **Delegated Permissions**.  This will enable your application to query the Graph API for users.
...
- Azure AD documentation on [Azure.com >>](https://azure.com)
